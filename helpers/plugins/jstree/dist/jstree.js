  ...
  $.jstree.core.prototype = {
    ...
    redraw_node: function (node, deep, is_callback, force_render) {
      ...
      if (this.settings.core.compute_elements_positions) {
        node.childNodes[1].setAttribute(
          "aria-setsize",
          m[obj.parent].children.length
        );
        node.childNodes[1].setAttribute(
          "aria-posinset",
          m[obj.parent].children.indexOf(obj.id) + 1
        );
      }
      ...
      if (state) {
        ...
        if (state.core) {
          ...
          if (state.core.loaded) {
            if (
              !this.settings.core.loaded_state ||
              !$.vakata.is_array(state.core.loaded) ||
          ...
          if (state.core.open) {
            if (
              !$.vakata.is_array(state.core.open) ||
      ...
      var tmp = {
          ...
          data:
            options && options.no_data
              ? false
              : $.extend(true, $.vakata.is_array(obj.data) ? [] : {}, obj.data),
  ...
  (function ($) {
    ...
    $.vakata.context = {
      ...
      _execute: function (i) {
        ...
        return i &&
          (!i._disabled ||
            ($.vakata.is_function(i._disabled) &&
              !i._disabled({
                item: i,
                reference: vakata_context.reference,
                element: vakata_context.element,
      ...
      _parse: function (o, is_callback) {
        ...
        $.each(o, function (i, val) {
          ...
          str +=
            ...
            (val._class || "") +
            (val._disabled === true ||
            ($.vakata.is_function(val._disabled) &&
              val._disabled({
                item: val,
                reference: vakata_context.reference,
                element: vakata_context.element,
        ...
        function (e) {
          ...
          if (
            ...
            (this.settings.dnd.is_draggable === true ||
              ($.vakata.is_function(this.settings.dnd.is_draggable) &&
        ...
        if ($.vakata.is_function(a)) {
          return a.call(
            ...
            function (d) {
              ...
              this._load_nodes(
                !$.vakata.is_array(d) ? [] : $.vakata.array_unique(d),
                function () {
                  this.search(
                    str,
                    true,
