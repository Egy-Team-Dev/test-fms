...
const Settings = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: darkmode && "rgb(21 25 37)" , position:'absolute',top:'-40px',zIndex:'2000000',backgroundColor:'white' }}
    >
      {isToggleConfigOpen && (
        <>
          <Button
          ...
          <h4 className={`${Styles.title} pt-2 ms-3`} >{t("config_key")}</h4>
