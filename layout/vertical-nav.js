...
const VerticalNav = () => {
  ...
  const userRole =
    ...
    session[0]?.user?.user?.role?.toLowerCase();
  ...
  return (
    <>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        {/* <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/troubleShooting" passHref={true}>
            <a>
              <div
                className={`${
                  router.pathname === "/troubleShooting" ? "active" : ""
                } nav-link `}
              >
                <FontAwesomeIcon icon={faHeadset} className='ms-1 fs-5' />

                <span className="item-name">{t("trouble_shooting")}</span>
              </div>
            </a>
          </Link>
        </Accordion.Item> */}
        ...
        {/* <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/vehiclesdahboard" passHref={true}>
            <a>
              <div
                className={`${
        ...
        <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/Driver" passHref={true}>
            <a>
              <div
                className={`${
